...
//       const senderUser = listUserInRoom.find(
//         (user) => user.roomId === room && user.socketId === socket.id
//       );
...
//       } else {
//         console.log("Sender not found in the room's user list.");
//       }
//     });

//     // Xử lý khi một người dùng ngắt kết nối
//     socket.on("disconnect", () => {
//       const disconnectedUser = listUserInRoom.find((user) => user.socketId === socket.id);

//       if (disconnectedUser) {
//         const disconnectedUserId = disconnectedUser.userId;
//         const disconnectedRoomId = disconnectedUser.roomId;

//         listUserInRoom = listUserInRoom.filter((user) => user.socketId !== socket.id);
//         socket.leave(disconnectedRoomId);

//         console.log(`User ${disconnectedUserId} disconnected`);
//         console.log("Updated listUserInRoom after user disconnected:", listUserInRoom);
